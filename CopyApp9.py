...
#HG= tkinter.Button(top,text= "Highlight",width = 15, height = 1, bg= '#F39C12', command= method4)
#HG= tkinter.Button(top,text= "Highlight",width = 15, height = 1, bg= '#F39C12', command= method4)
#HG= tkinter.Button(top,text= "Highlight",width = 15, height = 1, bg= '#16A085', command= method4)
HG.place(x=1,y=55)
HG['font']= MyFont
Help= tkinter.Button(top,text= "?",width = 1, height = 1, bg='#85929E',command = method9)
Help.place(x=114,y=2)
Help['font']= MyFont
secure= tkinter.Button(top,text= "Secure",width = 15,bg='#2E4053', height = 1,command= method8)
